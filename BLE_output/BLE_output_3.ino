...
void explorerPeripheral(BLEDevice peripheral) {
  ...
  if (!(peripheral.discoverAttributes())) {peripheral.disconnect(); return;}
  ...
  while (peripheral.connected()) {
    ...
    // Serial.print(",  (0x");printData(characteristic.value(), characteristic.valueLength());Serial.print(")");
    
    if (pressure > 103000) {digitalWrite(pompPin, HIGH);}
